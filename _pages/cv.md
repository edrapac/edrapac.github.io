...
*	Leveraged offensive tooling such as BloodHound, Impacket, Responder, and NetExec to assess and demonstrate risk within Active Directory environments.
*	Authored detailed penetration test reports and delivered findings to both technical and non-technical stakeholders, providing clear remediation guidance.


Bishop Fox                                                                              2025 – 2025  
Penetration Tester - Contractor
* Conduct web application, network, and cloud penetration tests to identify and exploit security vulnerabilities for enterprise clients across multiple industries
*	Develop and utilize custom scripts and tools (Python, JavaScript, etc.) to automate testing and enhance assessment efficiency.
*	Serve as a trusted security advisor to clients, communicating complex technical risks and supporting informed business decisions
